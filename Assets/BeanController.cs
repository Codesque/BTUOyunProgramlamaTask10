...
public class BeanController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Audio Source komponentine eris 
    ...
    public void ShootLaser()
    {
        ...
        if(Input.GetKeyDown(KeyCode.Space) && lastShotTime + Cooldown < Time.time)
        {
            ...
            // Lazer atis sesini Oynat 
            source.clip = laserShootClip; 
            source.loop = false; 
            source.Play();
    ...
    // BuffController bu methodu cagirarak buff sesi caldirilir.
    public void PlayBuffSound() {

        source.clip = buffSound; 
        source.loop = false; 
        source.Play();
